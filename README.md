...
Live payments need the founder's Stripe / PayPal keys (until then only the admin test payment works); product & builder data and prices; shipping rates and sales tax; the Resend key (contact form, verification and reset e-mails wait for it); legal copy; subscriptions. See `../notes/open-questions-for-founder.md`.
