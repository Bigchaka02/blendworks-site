...
(function () {
  ...
  const PROVIDER_ORDER = ["stripe", "applepay", "googlepay", "cashapp", "paypal", "venmo", "zelle"];   // Stripe group, PayPal group, Zelle
  const SUBMIT = { stripe: "Continue to Stripe", applepay: "Continue to Apple Pay", googlepay: "Continue to Google Pay", paypal: "Continue to PayPal", "venmo:api": "Continue to Venmo", "venmo:manual": "Place order, then pay by Venmo", "cashapp:api": "Continue to Cash App", "cashapp:manual": "Place order, then pay by Cash App", "zelle:manual": "Place order, then pay by Zelle", test: "Place test order" };
