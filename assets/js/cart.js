...
(function () {
  ...
  BW.cart = {
    ...
    setQty: function (id, qty) {
      ...
      if (line) { line.qty = clamp(qty, BW.getProduct(id)); write(next); }
    },
    ...
    lines: function () { return items.map(function (l) { var p = BW.getProduct(l.id); return p && { id: l.id, qty: l.qty, product: p, lineTotal: p.price * l.qty }; }).filter(Boolean); },
